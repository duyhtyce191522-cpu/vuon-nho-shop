...
const SEED_PRODUCTS = [
  {
    id: "p1",
    name: "Trầu bà Nam Mỹ",
    desc: "Một chút xanh, một chút đáng yêu — Monstera sẽ giúp góc nhỏ của bạn luôn tràn đầy sức sống và tươi mới.",
    price: 185000,
    category: "Cây lớn",
    stock: 8,
    icon: "🌿"
  },
  {
    ...
    desc: "Bé nhỏ xinh xắn chẳng cần chăm sóc cầu kỳ, chỉ một chút nước mỗi tuần là đã đủ xanh tươi, dịu dàng làm bạn với góc bàn mỗi ngày.",
    price: 45000,
    category: "Sen đá",
    stock: 24,
    icon: "🌺"
  },
  {
    id: "p3",
    name: "Lưỡi hổ vàng",
    desc: "Chàng dũng sĩ khoác áo sọc vàng luôn đứng gác âm thầm góc phòng, lọc sạch bụi bẩn suốt đêm để trao cho bạn một giấc ngủ thật an yên.",
    price: 95000,
    category: "Cây lớn",
    stock: 15,
    icon: "🪴"
  },
  {
    ...
    desc: "Đôi tai nhỏ xinh, dáng đứng đáng yêu — bé Xương Rồng luôn sẵn sàng làm góc phòng của bạn thêm vui mắt và tràn đầy sức sống.",
    price: 39000,
    category: "Sen đá",
    stock: 30,
    icon: "🌵"
  },
  {
    ...
    desc: "Bé Trầu Bà nhỏ xinh cứ thế vươn mình bên kệ sách, từng chiếc lá đung đưa nhẹ nhàng như đang chào bạn sau một ngày dài.",
    price: 68000,
    category: "Cây leo",
    stock: 12,
    icon: "🌱"
  },
  {
    ...
    desc: "Món quà nung ấm từ đất mẹ với đôi má hồng mộc mạc, luôn mở rộng vòng tay để ủ ấm bộ rễ và nâng niu từng mầm xanh nhỏ bé lớn khôn.",
    price: 55000,
  ...
  },
  {
    id: "p7",
    name: "Kumanthong",
    desc: "Bé nhỏ đáng yêu với vẻ ngoài tinh nghịch, sẵn sàng làm người bạn đồng hành mang đến chút vui vẻ và ấm áp cho góc nhỏ của bạn.",
    price: 100000000,
    category: "Chậu & phụ kiện",
    stock: 15,
    icon: "😈"
